...
def main():
    ...
    np.random.seed(seed)
    wcusum= wCUSUM(mdl, threshold=THRES, expected_vals=expected_vals, propensity_beta=None, alpha_spending_func=alpha_spending_func, subgroup_func=subgroup_func, delta=args.delta, n_bootstrap=args.n_boot)
